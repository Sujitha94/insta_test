// models/ChatflowWelcomePage.js - MongoDB schema for welcome page configuration
...
const chatflowwelcomePageSchema = new mongoose.Schema({
  tenentId: {
    type: String,
    required: true,
    unique: true
...
chatflowwelcomePageSchema.pre('validate', function(next) {
...
module.exports = mongoose.models.ChatflowWelcomePage || mongoose.model('ChatflowWelcomePage', chatflowwelcomePageSchema);
